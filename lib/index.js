...
class TCRListings {
  ...
  async getListings(applicationLogs, nonApplicationLogs = [], localListings = {}) {
    ...
    return this.changeMatchListingsWithLogs(nonApplicationLogs, immutableListings)
  }
  ...
  async createListing({ logData, txData, eventName }) {
    ...
    if (ipfsCheckMultihash(data)) {
      ...
      try {
        ...
        return this.createListing({ logData, txData, eventName })
      }
  ...
  changeMatchListingWithLog(matchListing, { logData, txData, eventName }) {
    ...
    switch (eventName) {
      ...
      case '_VoteCommitted':
        ...
        // TODO: FIX for re-submitted votes
